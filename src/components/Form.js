...
export default function Form() {
  ...
  const handleSubmit = async () => {
    ...
    const contract_sb = new ethers.Contract(
      contractAddr,
      sbcontract_abi,
      signer
    );
  ...
  return (
    <Container bg="#9DC4FB" maxW="full" mt={0} centerContent overflow="hidden">
      ...
      >
        Note: This DAPP is developed on Ropsten Testchain. Please add ropsten to
        buy tokens
      </p>
      <Flex>
        <Box
              ...
              <WrapItem>
                <Box>
                  ...
                  <Text
                    ...
                    fontSize={25}
                  >
                    <strong>Connect With Swadhin Biswas 👇👇</strong>
                  </Text>
                  <HStack
                    mt={{ lg: 5, md: 5 }}
                    spacing={5}
                  ...
                  >
                    ...
                    <Link
                      href="https://api.whatsapp.com/send?phone=8801928034856"
                      target="_blank"
                    >
                      <IconButton
                        aria-label="whatsapp"
                ...
                <Box bg="white" borderRadius="lg">
                  <Box m={8} color="#0B0E3F">
                    <VStack spacing={5}>
                      <FormControl id="name">
                        <FormLabel>
                          Number of tokens (min 500, max 25000)
                        </FormLabel>
                        <Input
                          type="number"
                          size="md"
